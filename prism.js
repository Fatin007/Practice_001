/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+c+csharp+cpp+go+java+kotlin+markup-templating+matlab+perl+php+python+ruby+swift&plugins=line-numbers+toolbar+copy-to-clipboard */
var _self =
